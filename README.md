...
`VITE_HCAPTCHA_SITE_KEY`. Use the UUID-shaped site key from the hCaptcha site's Settings page,
not the site name or label. The site key is public and is embedded in the Vite bundle; keep the
